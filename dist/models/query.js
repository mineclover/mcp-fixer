...
export class QueryModel {
     ...
     */
    static validateCreate(queryData) {
        try {
     ...
     */
    static validateExecutionParams(query, params) {
        try {
     ...
     */
    static update(existingQuery, updateData) {
        return {
            ...existingQuery,
            ...updateData,
     ...
     */
    static prepareOperation(query, params) {
     ...
     */
    static resolveTemplate(template, params) {
     ...
     */
    static isSchemaCompatible(query1, query2) {
