...
export const JsonSchemaSchema = z.record(z.string(), z.any()).refine((schema) => {
...
export class FixedInterfaceModel {
     ...
     */
    static validateCreate(interfaceData) {
        try {
     ...
     */
    static validateJsonSchema(schema) {
        try {
     ...
     */
    static validateResponseSchema(responseSchema) {
        try {
     ...
     */
    static update(existingInterface, updateData) {
        return {
            ...existingInterface,
            ...updateData,
        };
     ...
     */
    static isCompatibleWithTool(fixedInterface, toolCapabilities) {
     ...
     */
    static toDatabase(fixedInterface) {
        return {
     ...
     */
    static generateSignature(fixedInterface) {
        const data = {
            name: fixedInterface.name,
            version: fixedInterface.version,
     ...
     */
    static isRecentlyValidated(fixedInterface, thresholdHours = 24) {
