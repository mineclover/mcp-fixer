...
export async function executeStatsCommand(interfaceName, interfaceManager, options) {
    try {
        if (options.all) {
...
async function showInterfaceStats(interfaceName, interfaceManager, options) {
    // Find interface
...
async function showGlobalStats(interfaceManager, options) {
...
async function showAllInterfaceStats(interfaceManager, options) {
...
async function showUsagePatterns(interfaceManager, options) {
...
async function generatePerformanceReport(interfaceManager, options) {
    const reportContent = `
<!DOCTYPE html>
<html>
<head>
...
async function exportStatsToCSV(stats, filename) {
    const csvContent = [
        'metric,value,unit',
